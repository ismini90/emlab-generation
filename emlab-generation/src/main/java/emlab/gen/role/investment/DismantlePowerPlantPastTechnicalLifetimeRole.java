...
public class DismantlePowerPlantPastTechnicalLifetimeRole extends AbstractRole<EnergyProducer>
    ...
    public void act(EnergyProducer producer) {
        ...
        for (PowerPlant plant : reps.powerPlantRepository.findOperationalPowerPlantsByOwner(producer,
                getCurrentTick())) {
            // logger.warn("Acutal permite time: " +
            // plant.calculateActualPermittime());
            // logger.warn("Acutal lead time: " +
            // plant.calculateActualLeadtime());
            // logger.warn("Get actual life time: " +
            // plant.getActualLifetime());
            // logger.warn("Calculate actual life time: " +
            // plant.calculateActualLifetime());
            // logger.warn("Expectedlifetime: " +
