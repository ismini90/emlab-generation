...
for(exPostBoolean in exPostExAnteVariable){
  ...
  for(fipBiasFactor in feedInPremiumBiasFactorArray){
    ...
    for(runIterator in 1:noOfRepetitions){
     ...
     writeLines(xmlFileContent3, paste("/Users/kaveri/Desktop/emlabGen/scenario/TestRuns1104Sensitivity/", filestump,"EP",exPostBoolean,"BF",fipBiasFactor*100, "-", runIterator, ".xml", sep=""))
    }
